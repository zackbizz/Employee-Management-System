...
<html>
    ...
    <div class="row ">
        ...
        <div class="col-12 col-lg-6 col-md-6">
            <div class="card shadow" style="width: 20rem;height:600px;margin-top:5px;margin-bottom:10px;margin-left:40px">
            <input type="file" id="bannerImg" /><br>
 ...
 ?>
                    ...
                    <p class="card-text">Tel: <strong>+251<?php echo $tel=$r['tel'];?> </p>
                    <a href="editbio.php?id=<?php echo $r['id']; ?>"><button class="btn btn-primary">Edit Profile</button></a>
                    <a href="addbio.php"><button class="btn btn-primary">Add Profile</button></a>
